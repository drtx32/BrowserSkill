...
try {
  ...
  // npm 12 returns a package-name keyed object, while older npm versions
  // return a one-element array. Accept both shapes so the check is stable
  // across the Node versions used by the CI runners.
