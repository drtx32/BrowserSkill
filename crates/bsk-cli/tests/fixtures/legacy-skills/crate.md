...
1. Define success from the user's request. For a required browser profile, use
   the verified instance selector from **Required browser profiles** above.
   Otherwise use the bootstrapped default session or the alternate start path.
